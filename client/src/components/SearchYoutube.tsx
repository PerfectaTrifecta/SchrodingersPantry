   ...
   //const { video: { videoId } } = video;
    return (
      ...
      <div>
       ...
       <iframe width="345" height="300" src="https://www.youtube.com/embed/VgaRwWS3o" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
    )
  }
